...
public class prekesredagavimas extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.prekesredagavimas);
        ...
        String prekesid123 = getIntent().getStringExtra("EXTRA_SESSION_ID");

        EditText editText = (EditText)findViewById(R.id.edprekesid);
        editText.setText(prekesid123, TextView.BufferType.EDITABLE);

        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(prekesredagavimas.this, PrekesList.class);
                startActivity(i);
            }
        });
            ...
            public void onClick(View v) {
                try {
                    if ((pavadinimas.getText().toString().trim().equals("") && dydis.getText().toString().trim().equals("")) || kaina.getText().toString().trim().equals("")) {
                        ...
                        Toast.makeText(prekesredagavimas.this,
