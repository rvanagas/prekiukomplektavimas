...
public class Console extends Activity {
    ...
    private Button mButtonSend, mButtonSend11;
	CheckBox c1,c2;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mButtonSend11 = (Button) findViewById(R.id.button11);
		mButtonSend11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				imam(); //close connection
			}
		});
	}
	...
	public void imam() {
		if (((c1) ).isChecked() && (c2).isChecked()) {
			String gerai = ListViewCheckboxesActivity.getkoja3();
			String text = "11";

			sendMessages(gerai);
			mMessage.add(new CustomizedMessage(gerai, false));
			updateUI();
			Toast.makeText(Console.this,
					"Visi", Toast.LENGTH_LONG).show();
		}
		else {
			Toast.makeText(Console.this,
					"Nevisi", Toast.LENGTH_LONG).show();
		}
	}
...
//	}
	...
	mMessage = new ArrayList<CustomizedMessage>();
