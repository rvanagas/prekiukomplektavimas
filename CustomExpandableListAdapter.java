...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.issokantysuzsakymailist, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.issokantysuzsakymaigroup, null);
        }
        TextView listTitleTextView = (TextView) convertView
                .findViewById(R.id.listTitle);
        listTitleTextView.setTypeface(null, Typeface.BOLD);
        listTitleTextView.setText("Užsakymas nr."+listTitle+" "+ "Būsena:" + " " + "Neįvygdytas");
        return convertView;
    }
